...
export const api = {
  ...
  // Course endpoints
  getCourses: () => Promise.resolve({ data: mockData.courses }),
  getCourse: (courseId) => Promise.resolve({ data: mockData.courses.find(c => c.id === courseId) }),
  
  // Certificate endpoints
  getCertificates: () => Promise.resolve({ data: mockData.certificates }),
  getCertificate: (certId) => Promise.resolve({ data: mockData.certificates.find(c => c.id === certId) }),
  
  // Rewards endpoints
  getRewards: () => Promise.resolve({ data: mockData.rewards }),
}
